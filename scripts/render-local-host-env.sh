...
export INGESTION_MAX_PAGES="500"
export INGESTION_MAX_TEMP_BYTES="805306368"
export INGESTION_MEMORY_LIMIT_BYTES="1073741824"
...
export RETRIEVAL_SUMMARY_LLM_MAX_CALLS="${RETRIEVAL_SUMMARY_LLM_MAX_CALLS:-4}"
...
export RETRIEVAL_DEPENDENCY_TIMEOUT="${RETRIEVAL_DEPENDENCY_TIMEOUT:-2m}"
export RETRIEVAL_SUMMARY_LLM_TIMEOUT="${RETRIEVAL_SUMMARY_LLM_TIMEOUT:-2m}"
...
export EDGE_RETRIEVAL_SEARCH_DEADLINE="${EDGE_RETRIEVAL_SEARCH_DEADLINE:-2m}"
export EDGE_CATALOG_PREVIEW_DEADLINE="${EDGE_CATALOG_PREVIEW_DEADLINE:-5s}"
