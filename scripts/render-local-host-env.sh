...
export LAYOUT_RABBITMQ_URI_FILE="$root_dir/$host_secret_dir/layout_rabbitmq_uri"
export LAYOUT_MINIO_ACCESS_KEY_FILE="$root_dir/$secret_dir/layout_minio_access_key"
export LAYOUT_MINIO_SECRET_KEY_FILE="$root_dir/$secret_dir/layout_minio_secret_key"
export LAYOUT_WORK_CONCURRENCY="${LAYOUT_WORK_CONCURRENCY:-1}"
export LAYOUT_MEMORY_LIMIT_BYTES="${LAYOUT_WORKER_MEMORY_LIMIT_BYTES:-2147483648}"
export LAYOUT_REQUEST_QUEUE="ingestion.content-selection-requests.v1"
export LAYOUT_RESULT_EXCHANGE="raglibrarian.ingestion.content-selection-results.v1"
export LAYOUT_MAX_ITEMS_PER_LOCATION="2048"
export LAYOUT_MAX_ITEM_TEXT_BYTES="65536"
export LAYOUT_MAX_XML_TOKENS="2000000"
export LAYOUT_MAX_XML_DEPTH="32"
export LAYOUT_PARSER_TIMEOUT="10m"
...
export RETRIEVAL_SUMMARY_LLM_RETRY_ATTEMPTS="${RETRIEVAL_SUMMARY_LLM_RETRY_ATTEMPTS:-1}"
export RETRIEVAL_SUMMARY_LLM_RETRY_INITIAL_BACKOFF="${RETRIEVAL_SUMMARY_LLM_RETRY_INITIAL_BACKOFF:-1s}"
export RETRIEVAL_SUMMARY_LLM_RETRY_MAXIMUM_BACKOFF="${RETRIEVAL_SUMMARY_LLM_RETRY_MAXIMUM_BACKOFF:-10s}"
...
export RETRIEVAL_RECIPROCAL_RANK_FUSION_K="${RETRIEVAL_RECIPROCAL_RANK_FUSION_K:-60}"
export RETRIEVAL_QDRANT_DOCUMENT_EVIDENCE_LIMIT="${RETRIEVAL_QDRANT_DOCUMENT_EVIDENCE_LIMIT:-3}"
...
export RETRIEVAL_SUMMARY_CACHE_TTL="${RETRIEVAL_SUMMARY_CACHE_TTL:-0s}"
export RETRIEVAL_SUMMARY_CACHE_MAX_ENTRIES="${RETRIEVAL_SUMMARY_CACHE_MAX_ENTRIES:-0}"
export RETRIEVAL_SUMMARY_CACHE_NEGATIVE_REUSE="${RETRIEVAL_SUMMARY_CACHE_NEGATIVE_REUSE:-false}"
export RETRIEVAL_SUMMARY_CACHE_NEGATIVE_MINIMUM_COSINE="${RETRIEVAL_SUMMARY_CACHE_NEGATIVE_MINIMUM_COSINE:-0.985}"
export RETRIEVAL_SUMMARY_CACHE_NEGATIVE_CANDIDATE_LIMIT="${RETRIEVAL_SUMMARY_CACHE_NEGATIVE_CANDIDATE_LIMIT:-32}"
export RETRIEVAL_SUMMARY_CACHE_HMAC_KEY_FILE="$root_dir/$host_secret_dir/retrieval_summary_cache_hmac_key"
export RETRIEVAL_SUMMARY_CACHE_CLEANUP_INTERVAL="${RETRIEVAL_SUMMARY_CACHE_CLEANUP_INTERVAL:-15m}"
export RETRIEVAL_SUMMARY_CACHE_CLEANUP_TIMEOUT="${RETRIEVAL_SUMMARY_CACHE_CLEANUP_TIMEOUT:-30s}"
export RETRIEVAL_SUMMARY_CACHE_CLEANUP_BATCH_SIZE="${RETRIEVAL_SUMMARY_CACHE_CLEANUP_BATCH_SIZE:-256}"
...
export ANSWER_CACHE_CAPACITY="${ANSWER_CACHE_CAPACITY:-0}"
export ANSWER_CACHE_TTL="${ANSWER_CACHE_TTL:-0s}"
export ANSWER_CACHE_MINIMUM_COSINE="${ANSWER_CACHE_MINIMUM_COSINE:-0.95}"
