...
func Load() (Config, error) {
	...
	return Config{Address: optional("CATALOG_GRPC_ADDR", ":50052"), TLS: internaltls.Files{CA: ca, Certificate: cert, Key: key}, RunAs: process.Identity{UID: uid, GID: gid}}, nil
}
